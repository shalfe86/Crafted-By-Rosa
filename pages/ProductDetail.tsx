...
const ProductDetail: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white pt-32 pb-20 px-4 md:px-12">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
            ...
            <motion.div 
                ...
                className="relative aspect-[4/5] lg:aspect-square bg-zinc-900 rounded-3xl overflow-hidden border border-white/10"
            >
                <img 
                    src={item.imageUrl} 
                    alt={item.title} 
            ...
            <div className="flex flex-col justify-center">
                ...
                >
                    <div className="flex items-center gap-4">
                        <span className="px-3 py-1 rounded-full border border-amber-500/30 text-amber-500 text-xs tracking-widest uppercase bg-amber-900/10">
                            {item.category}
                        </span>
                    </div>
                    ...
                    <div className="pt-8 flex flex-col sm:flex-row gap-4">
                        <Link 
                            to="/custom-request"
                            className="flex-1 bg-white text-black py-4 rounded-xl font-medium hover:bg-amber-50 transition-colors flex items-center justify-center gap-2"
                        >
                            <MessageSquareHeart size={18} />
                            Inquire / Request Custom
                        </Link>
                        <button className="px-6 py-4 border border-white/10 rounded-xl hover:bg-white/5 transition-colors text-white" title="Share">
                            <Share2 size={18} />
                        </button>
                    </div>
